...
export function createMcpServer(
    ...
    async (extra: any) => {
      ...
      try {
        ...
        if (
          ...
          const workspaceInfos: WorkspaceInfo[] = result.workspaces.map(
            (ws) => ({
              id: ws.id,
              name: ws.name,
            })
  ...
  server.tool(
    ...
    async ({ functionId }) => {
      console.log(
        "[mcpServerFactory] checkDeployment called with functionId:",
        functionId
      );
  ...
  const getFunctionCodeTool = server.tool(
    ...
    async ({ functionId }) => {
      console.log(
        "[mcpServerFactory] getFunctionCode called with functionId:",
        functionId
      );
  ...
  server.tool(
    ...
    async ({ functionId }) => {
      console.log(
        "[mcpServerFactory] listPackages called with functionId:",
        functionId
      );
  ...
  server.tool(
    ...
    async () => {
      ...
      const toolsToInspect = ["executeFunction", "getFunctionCode", "updateFunctionCode", "listPackages"];
