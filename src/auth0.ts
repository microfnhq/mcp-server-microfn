...
export async function getUserInfo(domain: string, accessToken: string): Promise<UserInfo> {
...
export function createSecureCookie(
	...
	const { httpOnly = true, secure = true, sameSite = "Lax", maxAge = 3600, path = "/" } = options;
